...
// Since the function nestedFunction is within the scope of myFunction as the parent scope, it can reach within the whole myFunction function and grab the nested interal there.
...
const zooAnimals = [
  ...
  */
  function lowerCaseNames(lowerCaseNamesCB){
    const lowCaseAnimalNames = lowerCaseNamesCB.map(function(item){
